This is a browser extension for Chromium based browsers called "Later-List". This extension will function as a "read later" app with the following features:
